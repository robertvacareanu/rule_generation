...
class RuleGeneration:
    ...
    def random_surface_rule(
        ...
        # print('concat_sn', [str(self.concat_surface_nodes(x)) for x in all_nodes])
        # print('concat_sn', [str(self.concat_surface_nodes(x)) for x in all_nodes])
        # print('concat_sn', [str(self.concat_surface_nodes(x)) for x in all_nodes])
        # print('concat_sn', [str(self.concat_surface_nodes(x)) for x in all_nodes])
        # print('x')
        # print('-------------')
        # print([self.concat_surface_nodes(n) for n in all_nodes])
        # exit()
        # concatenate remaining nodes
        # rule = self.concat_surface_nodes(nodes)
        # return surface rule
        # print("\tRANDOM_SURFACE_RULE close")
        return [self.concat_surface_nodes(x) for x in all_nodes]
